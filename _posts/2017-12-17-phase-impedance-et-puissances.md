...
Évidemment, pour un circuit, si on cherche de la puissance active, celle qu'on recherche généralement, on va faire la chasse à la partie imaginaire (puissance réactive) consommatrice inutile de courant, ce qui correspond à augmenter le fameux cos(φ).
...
On comprendra aisément que le but du jeu est d'obtenir un cos(φ) le plus proche possible de 1 afin de maximiser l'utilisation du courant à des fins utiles, c'est à dire générer de la puissance utile pour fournir un travail effectif. Mathématiquement, la chasse à la partie imaginaire est ouverte.
